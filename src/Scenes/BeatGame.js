class BeatGame extends Phaser.Scene {
    ...
    create(){
        ...
        my.text.GameOver2 = this.add.bitmapText(game.config.width/2 - 600, game.config.height/2 - 140, "rocketSquare", "Enter the door to play again");
    ...
    update(){
        ...
        this.cameras.main.once(Phaser.Cameras.Scene2D.Events.FADE_OUT_COMPLETE, (cam, effect) => {
            this.scene.start("platformerScene", {score: this.myScore});
        })
