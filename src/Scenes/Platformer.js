class Platformer extends Phaser.Scene {
    ...
    init() {
        ...
        this.DRAG = 2200;    // DRAG < ACCELERATION = icy slide
        this.JUMP_VELOCITY = -630;
    ...
    update() {
        ...
        this.cameras.main.once(Phaser.Cameras.Scene2D.Events.FADE_OUT_COMPLETE, (cam, effect) => {
            this.scene.start("level2", {gemsCollected: this.gemsCollected});
        })
    }
